...
#include "JumpShootingCharacter.generated.h"


UCLASS(config=Game)
class AJumpShootingCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<UUserWidget> InformationWidgetClass;
	UUserWidget* InformationWidget;
